...
var PrimerPaginaComponent = /** @class */ (function () {
    ...
    PrimerPaginaComponent.prototype.asignarHecho = function () {
        this.router.navigate(['/hechos']);
    };
    PrimerPaginaComponent.prototype.listarMecanismos = function () {
        this.router.navigate(['/listarComponentes']);
    };
